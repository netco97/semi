...
//    }
	...
	public int loadingCheckLike(int song_id) {
		...
		Object userFullPhoneNumberAttribute = httpSession.getAttribute("userFullPhoneNumber");

		if (userFullPhoneNumberAttribute == null) {
			return 0;
		}

		userFullPhoneNumber = userFullPhoneNumberAttribute.toString();
