...
public class MusicController {
	...
	public String createMusicUpload(@ModelAttribute MusicUploadDTO musicUploadDTO) {
	    ...
	    List<String> musicGenre = musicUploadDTO.getMusicGenre();
	    ...
	    System.out.println("선택된 음악 장르: " + musicGenre);
	    ...
	    String result_musicGenre = MusicService.listToString(musicGenre, "#");
	    String result_musicMood = MusicService.listToString(musicMood, "#");
	    
	    System.out.println("선택된 음악 장르 (#커스터마이징) :" + result_musicGenre);
