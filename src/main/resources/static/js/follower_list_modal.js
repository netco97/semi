...
function buildFollowerListHTML(followerList) {
    ...
    for (var i = 0; i < followerList.length; i++) {
        html += '<div onclick="gotodetail(' + followerList[i].targetUserId + ');">' + followerList[i].composer_name +
                '<img src="/images/profile/'+ followerList[i].composer_img+ '" style="max-width: 100px; max-height: 100px;">' +
                '</div>';
